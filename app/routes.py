...
from app.controllers.hostel_controller import create_hostel, get_all_hostels, get_hostel_by_id, update_hostel
from app.controllers.room_controller import create_room, get_all_rooms, get_room_by_id, update_room
